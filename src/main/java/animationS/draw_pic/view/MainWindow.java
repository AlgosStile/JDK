package animationS.draw_pic.view;



import animationS.common.CanvasRepaintListener;
import animationS.common.Interactable;
import animationS.common.MainCanvas;
import animationS.draw_pic.sprites.Background;
import animationS.draw_pic.sprites.Picture;
...
public class MainWindow extends JFrame implements CanvasRepaintListener, Thread.UncaughtExceptionHandler {
    ...
    public MainWindow() throws BallsOverflowException {
    ...
    private void initSprites() throws BallsOverflowException {
    ...
    public void addSprite(int x, int y) throws BallsOverflowException {
